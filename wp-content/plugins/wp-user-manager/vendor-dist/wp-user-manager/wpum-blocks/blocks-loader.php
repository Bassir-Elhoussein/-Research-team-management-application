...
class WPUM_Blocks
{
    ...
    {
        wp_enqueue_script('wpum-blocks', \WPUM_PLUGIN_URL . 'vendor-dist/wp-user-manager/wpum-blocks/build/index.js', ['wp-blocks', 'wp-i18n', 'wp-element', 'wp-components', 'wp-editor'], \WPUM_VERSION);
