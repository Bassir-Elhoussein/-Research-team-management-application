...
trait Request
{
    ...
    protected static function _validateParams($params = null)
    {
        if ($params && !\is_array($params)) {
            ...
            throw new \WPUM\Stripe\Exception\InvalidArgumentException($message);
        }
    }
    /**
    ...
    {
        $opts = \WPUM\Stripe\Util\RequestOptions::parse($options);
        $baseUrl = isset($opts->apiBase) ? $opts->apiBase : static::baseUrl();
        $requestor = new \WPUM\Stripe\ApiRequestor($opts->apiKey, $baseUrl);
