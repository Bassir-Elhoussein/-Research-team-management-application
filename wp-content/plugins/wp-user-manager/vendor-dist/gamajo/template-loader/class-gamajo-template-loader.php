 ...
 * @version   1.3.1
 */
if (!\class_exists('WPUM\\Gamajo_Template_Loader')) {
    /**
     * Template loader.
     *
    ...
    class Gamajo_Template_Loader
    {
         ...
         * @return string
         */
        public function get_template_part($slug, $name = null, $load = \true)
        {
        ...
        protected function get_template_paths()
        {
            ...
            $file_paths = array(10 => trailingslashit(get_template_directory()) . $theme_directory, 100 => $this->get_templates_dir());
