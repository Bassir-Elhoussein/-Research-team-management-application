...
use WPUM\Carbon_Fields\Helper\Color;
if (!\function_exists('WPUM\\carbon_field_exists')) {
...
if (!\function_exists('WPUM\\carbon_get')) {
...
if (!\function_exists('WPUM\\carbon_get_post_meta')) {
...
if (!\function_exists('WPUM\\carbon_get_network_option')) {
