...
class File_Field extends Field
{
    ...
    public function to_json($load)
    {
        ...
        $field_data = \array_merge($field_data, array('type_filter' => $this->field_type, 'value_type' => $this->value_type, 'value_meta' => Helper::get_attachment_metadata($value, $this->value_type)));
        return $field_data;
    }
}
