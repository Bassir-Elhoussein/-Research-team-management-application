...
namespace WPUM\Carbon_Fields\Libraries\Sidebar_Manager;
...
class Sidebar_Manager
{
    ...
    public function boot()
    {
        ...
        if (\function_exists('WPUM\\crb_get_default_sidebar_options')) {
    ...
    {
        wp_enqueue_style('carbon-sidebar-manager', \WPUM\Carbon_Fields\URL . '/core/Libraries/Sidebar_Manager/assets/css/app.css', array(), \WPUM\Carbon_Fields\VERSION);
        wp_enqueue_script('carbon-sidebar-manager', \WPUM\Carbon_Fields\URL . '/core/Libraries/Sidebar_Manager/assets/js/app.js', array(), \WPUM\Carbon_Fields\VERSION);
